...
Introduction
===========================
This Web App was built during a two week sprint called "Python Live Project" as an assignment for The Tech Academy's Software Developer Boot Camp. Prior to the project I completed a month long Python course that introduced the language syntax, history, capabilities, and challenged me with small projects/exercises throughout. Upon completion, I moved on to the Live Project portion that utilized agile project managemnt methodoligies, we practiced SCRUM. I met with a group of developers and our SCRUM master daily with Friday code retrospectives. We utilized Azure DevOps to collaborate on code development. Each developer chose their own topic of interest, built their apps within the same guidlines.  My project is a web app for managing one's person library's in a relational database fashion. You can create as many libraries as you want and add meta data that can relate the data for your viewing. You can Add, Update, and Delete any of the book data you Create on the app. My Web App was built using the Django Framework in PyCharm where I uesd the terminal to create a virtual environment and install the packages needed for the project. I implemented the MVT design pattern to throttle the database. This project exercized my skills in version control, research capabilities as well as my understanding for the MTV design pattern. Not only do I feel more confident building projects with this organization, I am excited to do more paired programming in the future. Below are a break down of the stories I completed and details of where I ran into roadblocks. 
